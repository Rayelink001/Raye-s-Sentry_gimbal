...
#define YAW_RC_CEN -0.0003f//0.05f//-0.00005f//YAW-RC通道转换率
#define YAW_MOUSE_RC_CEN -0.001f
#define PIT_RC_CEN 0.0002f///-0.004f//-0.000009f//PITCH-RC通道转换率
#define PIT_MOUSE_RC_CEN -0.0006f

#define YAW_OFFSET_ECD  2728            //yaw回正ECD值
#define YAW_OFFSET_ANGLE 16.7816162f    //pitch回正 角度值

#define PITCH_OFFSET_ECD 2650           //pitch回正 ECD值
#define PITCH_OFFSET_ANGLE 0.0f         //pitch回正 角度值
#define PITCH_MAX_RELATIVE_ANGLE 3000	 //pitch最大机械角度
#define PITCH_MIN_RELATIVE_ANGLE 2200	//pitch最小机械角度
