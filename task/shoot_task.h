...
#define FRIC_TARGGET_SPEED 6500.0f //设定摩擦轮的角速度

#define TRI_STOP_SPEED 0.0f
#define TRI_TARGGET_SPEED 3000.0f//6000.0f //设定拨弹盘角速度
...
#define BLOCK_TIME  20             //堵转时间判定
#define REVERSE_TIME 40            //堵转修复时间
...
/* 左摩擦轮电机速度PID */
#define FRIC_LEFT_SPEED_KP 6.0f
#define FRIC_LEFT_SPEED_KI 0.05f
#define FRIC_LEFT_SPEED_KD 0.0f
#define FRIC_LEFT_SPEED_PID_MAX_OUT 16000.0f
#define FRIC_LEFT_SPEED_PID_MAX_IOUT 5000.0f

/* 右边摩擦轮电机速度PID */
#define FRIC_RIGHT_SPEED_KP 6.0f
#define FRIC_RIGHT_SPEED_KI 0.05f
...
typedef struct
{
    ...
    const RC_ctrl_t *shoot_rc;//遥控器数据
		robo_led_state_t *led_state;//指示灯数据
...
extern shoot_control_mode_e get_shoot_control_mode(void);
